...
The goal of this project is to improve the open-source 3D software
Blender. This software can create 3D scenes from scratch, from
modelling to animation and render.
...
animate people of the environment, whose movements must be consistent
with the environment and other people's movements.
...
software. As we know, nothing exists for widely used free software
like Blender.
