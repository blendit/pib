\section{WP3 - Bibliography on Environment generation}
\label{WP3}
...
\paragraph{Remaining Work.} This Work Package is now finished, and the whole group moved from the bibliographical part to the coding part: we have chosen what to implement, we now need to implement it.
