...
\begin{frame}{What is Blend'it?}
  ...
  \begin{figure}%
\centering
\subfloat{\label{fig:first}\includegraphics<2>[height=6cm]{GUI_map_example.png}} ~ 
\subfloat{\label{fig:second}\includegraphics<2>[height=6cm]{GUI_crowd_example.png}} ~ 
\subfloat{\label{fig:third}\includegraphics<2>[height=6cm]{GUI_simulation_example.png}}
\subfloat{\label{fig:third}\includegraphics<1>[height=5cm]{GUI_env.png}}\\
\label{3figs}
